  ...
  return (
    <>
      ...
      <div className="cover w-full relative">
        <img
          className="object-cover w-full h-52 md:h-[400px]"
          src={currentUser.coverpic}
          alt="cover-image"
        />

        <div className="absolute -bottom-16 right-[33%] md:right-[48%]">
          <img
      ...
      <div className="info flex justify-center items-center my-16 mb-32 flex-col gap-2">
        ...
        <div className="payment flex gap-3 w-[80%] mt-12 flex-col md:flex-row">
