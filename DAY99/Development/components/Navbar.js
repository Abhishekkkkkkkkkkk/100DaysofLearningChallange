...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-900 flex items-center justify-between text-white md:h-16 flex-col sm:flex-row">
      <Link href="/" className="logo font-bold mx-8">GetMeAChai</Link>
      {/* <div className="logo font-bold mx-8">GetMeAChai</div> */}

      <div className="relative flex flex-col md:block gap-3 p-3">
        {session && <><button
