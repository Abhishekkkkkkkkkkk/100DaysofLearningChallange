...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <div className="flex justify-center text-white items-center h-[85vh] flex-col gap-4 sm:h-[100vh]">
        <div className="font-bold text-5xl text-center">Buy me a Chai</div>
        ...
        <div className="flex gap-5 justify-around flex-wrap">
          ...
          <div className="item space-y-3 flex flex-col items-center justify-center text-center max-w-xs">
            <img
              ...
              width={120}
              height={120}
              src="fan1.jpg" // Replace with actual image source
              alt="Fan 1"
            />
